...
<template>
  <div class="flex flex-col">
    <main class="">
      <section class="relative overflow-hidden bg-linear-to-b from-background to-muted/20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32">
          <div class="mx-auto max-w-3xl text-center">
            <h1 class="text-4xl sm:text-6xl font-bold tracking-tight text-gray-900 leading-tight">
